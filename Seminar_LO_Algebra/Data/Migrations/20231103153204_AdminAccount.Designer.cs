...
namespace Seminar_LO_Algebra.Data.Migrations
{
    ...
    [Migration("20231103153204_AdminAccount")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Seminar_LO_Algebra.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Seminar_LO_Algebra.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Seminar_LO_Algebra.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Seminar_LO_Algebra.Models.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Seminar_LO_Algebra.Models.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Seminar_LO_Algebra.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Seminar_LO_Algebra.Models.OrderItem", b =>
                {
                    b.HasOne("Seminar_LO_Algebra.Models.Order", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Seminar_LO_Algebra.Models.Product", null)
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Seminar_LO_Algebra.Models.ProductCategory", b =>
                {
                    b.HasOne("Seminar_LO_Algebra.Models.Category", null)
